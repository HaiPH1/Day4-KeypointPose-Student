...
python3 tools/visualize_pose.py --images dataset/images/train --labels ban_cung_nhom/dataset.duypx/dataset/labels/train --out /tmp/vis_review
python3 tools/visibility_report.py --labels dataset/labels/train --compare ban_cung_nhom/dataset.duypx/dataset/labels/train
```
